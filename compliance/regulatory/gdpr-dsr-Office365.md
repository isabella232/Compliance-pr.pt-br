...
O guia aborda como usar os produtos, serviços e as ferramentas administrativas do Office 365, de modo que ajudem você a encontrar dados pessoais ou informações pessoais para responder às DSRs. Especificamente, isso inclui como encontrar, acessar e agir sobre dados pessoais ou informações pessoais que residem na nuvem da Microsoft. Aqui está uma breve visão geral dos processos descritos neste guia:
...
- **Restringir:** restrinja o processamento dos dados pessoais, seja removendo as licenças de vários serviços on-line ou desativando os serviços desejados, quando possível. Você também pode remover dados da nuvem da Microsoft e mantê-los no local ou onde preferir.
...
- **Dados do Cliente:** todos os dados, incluindo todos os arquivos de texto, som, vídeo ou imagem, e software, que são fornecidos à Microsoft por, ou em nome de, um cliente pelo uso do serviço corporativo. Os Dados do Cliente incluem (1) informações identificáveis de usuários finais (por exemplo, nomes de usuário e informações de contato no Azure Active Directory) e Conteúdo do Cliente que um cliente carrega ou cria em serviços específicos (por exemplo, conteúdo do cliente em um documento do Word ou Excel ou no texto de um e-mail do Exchange Online; conteúdo do cliente adicionado a um site do SharePoint Online ou salvo em uma conta do OneDrive for Business).
- **Logs gerados pelo sistema:** logs e dados relacionados gerados pela Microsoft que ajudam a Microsoft a fornecer serviços corporativos aos usuários. Os logs gerados pelo sistema contêm principalmente dados pseudonimizados, como identificadores exclusivos (normalmente um número gerado pelo sistema) não podem identificar por conta própria uma pessoa individual, mas são usados para fornecer os serviços corporativos aos usuários. Os logs gerados pelo sistema também podem conter informações identificáveis sobre usuários finais, como um nome de usuário.
...
- **[Parte 1: Respondendo às DSRs quanto aos Dados do Cliente](#part-1-responding-to-dsrs-for-customer-data):** *Dados do Cliente* são dados produzidos e armazenados no Office 365 nas operações diárias de execução da sua empresa. Exemplos dos aplicativos do Office 365 mais usados que permitem criar dados incluem Word, Excel, PowerPoint, Outlook e OneNote. O Office 365 também consiste em aplicativos como o SharePoint Online, o Teams e o Forms que permitem que você colabore melhor com outras pessoas. A Parte 1 deste guia discute como descobrir o acesso, retificar, restringir, excluir e exportar dados dos aplicativos do Office 365 que foram usados para criar e armazenar dados nos serviços on-line do Office 365. Ele aborda produtos e serviços para os quais a Microsoft está atuando como um processador de dados para sua organização e, portanto, a funcionalidade de DSR é disponibilizada para o administrador de locatários.
- **[Parte 2: Respondendo a DSRs em relação aos insights gerados pelo Office 365](#part-2-responding-to-dsrs-with-respect-to-insights-generated-by-office-365):** o Office 365 fornece determinados insights através dos serviços como Delve, MyAnalytics e Workplace Analytics. Como esses insights são gerados e como responder a DSRs relacionadas a eles são explicados na Parte 2 deste guia.
- **[Parte 3: Respondendo às DSRs quanto aos logs gerados pelo sistema](#part-3-responding-to-dsrs-for-system-generated-logs):** quando você usa os serviços corporativos do Office 365, a Microsoft gera algumas informações, como logs de serviço que registram o uso ou o desempenho de recursos no serviços on-line. A maioria dos dados gerados pelo serviço contém identificadores de pseudônimos gerados pela Microsoft e, portanto, essa categoria geralmente é chamada neste documento como *logs gerados pelo sistema*. Embora esses dados não possam ser atribuídos a um titular de dados específico sem o uso de informações adicionais, alguns podem ser considerados pessoais de acordo com a definição do RGPD para "dados pessoais". A Parte 3 deste guia discute como acessar, excluir e exportar logs gerados pelo sistema.
...
Os serviços do Microsoft Office 365 também estão disponíveis nos seguintes ambientes de nuvem nacional: [Office 365 Germany](/microsoft-365/admin/admin-overview/learn-about-office-365-germany), [Office 365 operado pela 21Vianet (China)](/microsoft-365/admin/services-in-china/services-in-china) e [Office 365 US Government](https://www.microsoft.com/microsoft-365/government/compare-office-365-government-plans). A maioria das diretrizes para gerenciar solicitações de titulares de dados descritas neste artigo se aplica a esses ambientes de nuvem nacional. No entanto, devido à natureza isolada desses ambientes, há algumas exceções. Quando considerável para determinado subseção, essas exceções são destacadas em uma observação correspondente.
...
Para ajudar você a determinar onde pesquisar dados pessoais ou o que procurar, é útil identificar os aplicativos do Office 365 que as pessoas em sua organização podem usar para criar e armazenar dados no Office 365. Ter conhecimento disso restringe os aplicativos do Office 365 que entram no escopo de uma DSR e ajuda a determinar como pesquisar e acessar dados pessoais que estão relacionados a uma DSR. Especificamente, isso determina se é possível usar a ferramenta Pesquisa de Conteúdo ou se terá que usar a funcionalidade no aplicativo do aplicativo em que os dados foram criados.

Uma maneira rápida de identificar os aplicativos do Office 365 que as pessoas na sua organização estão usando para criar Dados do Cliente é determinar quais aplicativos estão incluídos na assinatura do Microsoft 365 para empresas da sua organização. Para fazer isso, você pode acessar as contas de usuário no portal de administração do Office 365 e analisar as informações de licenciamento de produto. Confira [Atribuir licenças aos usuários](/microsoft-365/admin/manage/assign-licenses-to-users).
...
A lista a seguir identifica os aplicativos do Office 365 que as pessoas usam na concepção do Conteúdo Criado pelo Cliente e que podem ser descobertos usando a Pesquisa de Conteúdo. Esta seção do guia de DSR fornece diretrizes sobre como descobrir, acessar, exportar e excluir dados criados com esses aplicativos do Office 365.
...
> 
> * [Criar uma pesquisa de Descoberta Eletrônica In-loco](/exchange/create-in-place-ediscovery-search-exchange-2013-help)
...
A primeira etapa ao responder a uma DSR é encontrar os dados pessoais que são o objeto da DSR. Isso consiste em usar a ferramenta Descoberta Eletrônica do Office 365 para pesquisar dados pessoais (entre todos os dados da sua organização no Office 365) ou ir diretamente para o aplicativo nativo no qual os dados foram criados. Esta primeira etapa, encontrar e revisar os dados pessoais em questão, ajudará você a determinar se uma DSR cumpre os requisitos da organização para atender ou declinar uma solicitação do titular dos dados. Por exemplo, depois de encontrar e revisar os dados pessoais em questão, você pode determinar que a solicitação não atende aos requisitos da organização porque isso pode afetar negativamente os direitos e a liberdade de outras pessoas, ou porque os dados pessoais estão contidos em um registro comercial no qual a organização tem um interesse comercial legítimo em manter.
...
- Sites do SharePoint Online. Isso inclui os sites associados aos Grupos do Microsoft 365 e o Microsoft Teams
...
- Comece pesquisando todos os locais de conteúdo da organização (o que pode ser feito em uma única pesquisa) para determinar rapidamente quais locais de conteúdo possuem itens que correspondem à sua consulta de pesquisa. Em seguida, você pode executar a pesquisa novamente e limitar o escopo dela aos locais específicos que apresentam itens relevantes.
- Use as estatísticas de pesquisa para identificar os principais locais que contêm itens que correspondem à sua consulta de pesquisa. Consulte [Exibir as estatísticas de palavra-chave para resultados de pesquisa de conteúdo](/microsoft-365/compliance/view-keyword-statistics-for-content-search).
- Pesquise no log de auditoria atividades recentes de arquivo e pasta executadas pelo usuário que é o assunto da DSR. Pesquisar o log de auditoria retorna uma lista de registros de auditoria que contêm o nome e o local dos recursos com os quais o usuário interagiu recentemente. Talvez você possa usar essas informações para criar uma consulta de pesquisa de conteúdo. Consulte [Pesquisar o log de auditoria no Centro de Conformidade e Segurança](/microsoft-365/compliance/search-the-audit-log-in-security-and-compliance).

#### <a name="building-search-queries-to-find-personal-data"></a>Criar consultas de pesquisa para encontrar dados pessoais

A DSR que você está investigando provavelmente contém identificadores que podem ser usados na consulta de pesquisa de palavra-chave para pesquisar os dados pessoais. Veja a seguir alguns identificadores comuns que podem ser usados em uma consulta de pesquisa para encontrar dados pessoais:
...
Pesquisar apenas por um endereço de e-mail ou uma ID de funcionário provavelmente retornará muitos resultados. Para limitar o escopo da pesquisa para que ela retorne o conteúdo mais relevante à DSR, você pode adicionar condições à consulta de pesquisa. Quando você adiciona uma condição, a palavra-chave e uma condição de pesquisa são conectadas de modo lógico pelo **E** operador Booliano. Isso significa que apenas os itens que corresponderem a *ambas* (palavra-chave e condição) serão retornados nos resultados da pesquisa.
...
Há muito mais condições de pesquisa e propriedades de documento ou email que você pode usar para criar consultas de pesquisa mais complexas. Veja a seção a seguir no tópico da Ajuda [Consultas de palavra-chave e condições de pesquisa para Pesquisa de Conteúdo](/microsoft-365/compliance/keyword-queries-and-search-conditions) para obter mais informações.

- [Propriedades de emails pesquisáveis](/microsoft-365/compliance/keyword-queries-and-search-conditions)
- [Propriedades de site pesquisáveis (documento)](/microsoft-365/compliance/keyword-queries-and-search-conditions)
- [Condições de pesquisa](/microsoft-365/compliance/keyword-queries-and-search-conditions)
...
Veja a seguir alguns exemplos de consultas de pesquisa que usam palavras-chave e condições para pesquisar dados pessoais em resposta a uma DSR. Os exemplos mostram duas versões da consulta: uma mostrando a sintaxe da palavra-chave (em que a condição é incluída na caixa Palavra-chave) e outra mostrando a versão baseada em GUI da consulta com condições.

##### <a name="example-1"></a>Exemplo 1

Este exemplo retorna arquivos do Excel em sites do SharePoint Online e contas do OneDrive for Business que contêm o endereço de email especificado. Os arquivos poderão ser retornados se o endereço de email aparecer nos metadados do arquivo.
...
Os itens parcialmente indexados (também chamados de *itens não indexados*) são itens de caixa de correio do Exchange Online e documentos do SharePoint Online e de sites do OneDrive for Business que, por algum motivo, não foram completamente indexados para pesquisa, o que significa que eles não podem ser pesquisados pela Pesquisa de Conteúdo. A maioria das mensagens de e-mail e dos documentos de site é indexada com êxito, pois eles se enquadram nos [limites de indexação do Office 365](/microsoft-365/compliance/limits-for-content-search). As mensagens de e-mail ou os arquivos não são indexados para pesquisa por estes motivos:

- O tipo de arquivo [não é reconhecido ou não tem suporte para indexação](/microsoft-365/compliance/partially-indexed-items-in-content-search). Entretanto, às vezes, o tipo de arquivo tem suporte para indexação, mas ocorreu um erro de indexação para um arquivo específico
...
- [Investigar itens parcialmente indexados na Descoberta Eletrônica do Office 365](/microsoft-365/compliance/investigating-partially-indexed-items-in-ediscovery)
- [Exportar itens não indexados](/microsoft-365/compliance/export-search-results)
...
- Depois de executar uma pesquisa, o número de itens parcialmente estimados é exibido nas estatísticas de pesquisa. Essa estimativa não inclui itens parcialmente indexados no SharePoint Online e OneDrive for Business. Exporte os relatórios para uma Pesquisa de Conteúdo a fim de obter informações sobre itens parcialmente indexados. O relatório **Unindexed Items.csv** contém informações sobre itens não indexados, incluindo o local do item, a URL, se o item estiver no SharePoint Online ou OneDrive for Business, e a linha do assunto (para mensagens) ou o nome do documento. Para obter mais informações, confira [Exportar um relatório da Pesquisa de Conteúdo](/microsoft-365/compliance/export-a-content-search-report).
...
Exporte os resultados de uma pesquisa de conteúdo e os itens parcialmente indexados do local de conteúdo que foi pesquisado. Você também pode exportar apenas os itens parcialmente indexados. Assim, é possível abri-los no aplicativo nativo e analisar o conteúdo. É preciso usar essa opção para exportar itens do SharePoint Online e do OneDrive for Business. Consulte [Exportar os resultados da Pesquisa de Conteúdo do Centro de Segurança e Conformidade](/microsoft-365/compliance/export-search-results).
...
Em vez de exportar todos os itens da caixa de correio parcialmente indexados de uma pesquisa, você pode executar novamente uma Pesquisa de Conteúdo para procurar uma lista específica de itens parcialmente indexados e exportá-los. Observe que isso só é possível para itens de caixa de correio. Consulte [Preparar um arquivo CSV para uma Pesquisa de Conteúdo direcionada no Office 365](/microsoft-365/compliance/csv-file-for-an-id-list-content-search).

### <a name="next-steps"></a>Próximas etapas

Depois de encontrar os dados pessoais relevantes à DSR, certifique-se de manter a Pesquisa de Conteúdo específica que foi usada para encontrar os dados. Você provavelmente reutilizará esta pesquisa para concluir outras etapas no processo de resposta à DSR, como [obter uma cópia dela](#providing-a-copy-of-personal-data), [exportá-la](#exporting-personal-data) ou [excluí-la permanentemente](#deleting-personal-data).
...
Uma pessoa usando o Office Lens (um aplicativo de câmera compatível com dispositivos iOS, Android e Windows) pode fotografar quadros de comunicações, documentos impressos, cartões de visita, entre outras coisas com muito texto. O Office Lens usa tecnologia de reconhecimento óptico de caracteres que extrai texto em uma imagem e o salva em um documento do Office, como Word, PowerPoint e OneNote ou em um arquivo PDF. Os usuários podem então carregar o arquivo que contém o texto da imagem na respectiva conta do OneDrive for Business no Office 365. Isso significa que você pode usar a ferramenta Pesquisa de Conteúdo para pesquisar, acessar, excluir e exportar dados em arquivos que foram criados de uma imagem do Office Lens. Para obter mais informações sobre o Office Lens, consulte:
...
Outra maneira de os usuários acessarem os dados de perfil do SharePoint é navegar até a **página de edição de perfil** na conta do OneDrive for Business, a qual pode ser acessada pelo caminho **EditProfile.aspx** sob a URL da conta do OneDrive for Business. Por exemplo, para um usuário <strong>usuario1@contoso.com</strong>, a conta do OneDrive for Business dele está localizada em:

```http
https://contoso-my.sharepoint.com/personal/user1\_contoso\_com/\_layouts/15/OneDrive.aspx
```

A URL da página de edição de perfil seria:

```http
https://contoso-my.sharepoint.com/personal/user1\_contoso\_com/\_layouts/15/EditProfile.aspx
```

Observe que as propriedades originadas no Azure Active Directory não podem ser alteradas no SharePoint Online. Entretanto, os usuários podem acessar a respectiva página **Conta** selecionando a respectiva **foto** no cabeçalho do Office 365 e selecionando **Minha conta**. Alterar as propriedades aqui pode exigir que os usuários trabalhem com seus administradores para descobrirem, acessarem ou retificarem uma propriedade do perfil de usuário.
...
Um administrador pode exportar todas as propriedades de Perfil de Usuário para um usuário usando o cmdlet **Export-SPOUserProfile** no PowerShell do SharePoint Online. Veja [Export-SPOUserProfile](/powershell/module/sharepoint-online/export-spouserprofile).

Para saber mais sobre perfis de usuário, confira [Gerenciar perfis de usuário no Centro de administração do SharePoint](/sharepoint/manage-user-profiles).

##### <a name="user-information-list-on-sharepoint-online-sites"></a>Lista de informações do usuário em sites do SharePoint Online

Um subconjunto do perfil de usuário do SharePoint de um usuário é sincronizado com a lista de Informações do Usuário de todos os sites que ele acessa ou que tem permissões para acessar. Isso é usado pelas experiências do SharePoint Online, como colunas Pessoas em bibliotecas de documentos, para exibir informações básicas sobre o usuário, como o nome do criador de um documento. Os dados em uma lista de Informações do Usuário correspondem às informações armazenadas no perfil de usuário do SharePoint e serão corrigidos automaticamente se a origem for alterada. Para usuários excluídos, esses dados permanecem nos sites com os quais eles interagiram, para a integridade referencial dos campos de colunas do SharePoint. 
...
4. Em **Configurações de Política**, a propriedade replicável controla se a propriedade será representada na lista Informações do usuário. Observe que nem todas as propriedades dão suporte a esse ajuste.

Um administrador pode exportar todas as propriedades de Informações do usuário para um usuário em determinado site usando o cmdlet **Export-SPOUserInfo** no PowerShell do SharePoint Online. Veja [Export-SPOUserInfo](/powershell/module/sharepoint-online/export-spouserinfo).

##### <a name="onedrive-for-business-experience-settings"></a>Configurações de experiência do OneDrive for Business

A experiência do OneDrive for Business de um usuário armazena informações que ajudam o usuário a encontrar o conteúdo de seu interesse e a navegar nele. A maioria dessas informações pode ser acessada pelos usuários finais usando os recursos do produto. Um administrador pode exportar as informações usando um [Script do PowerShell](/powershell/scripting/overview) e [comandos do CSOM (Modelo de Objeto do Lado do Cliente do SharePoint)](/sharepoint/dev/sp-add-ins/complete-basic-operations-using-sharepoint-client-library-code).

Veja [Exportar as configurações da experiência do OneDrive for Business](/sharepoint/export-odfb-lists) para saber mais sobre as configurações, como elas são armazenadas e como exportá-las.
...
5. Adicione uma condição de pesquisa e selecione a condição Tipo de Arquivo e use um para o valor do tipo de arquivo. Isso retornará todos os arquivos do OneNote nos resultados da pesquisa. A sintaxe da palavra-chave resultante seria parecida com [esta](#building-search-queries-to-find-personal-data):

   ```Query
   path:"<https://contosoedu.onmicrosoft.com/sites/9C> Biology/SiteAssets/9C Biology Notebook/" AND filetype="one"
   ```

6. Execute novamente a Pesquisa de Conteúdo. Os resultados da pesquisa devem incluir todos os arquivos do OneNote para o Bloco de Anotações de Classe da equipe da classe.

#### <a name="microsoft-to-do"></a>Microsoft To Do

As tarefas (chamadas de *tarefas pendentes*, que são salvas nas *listas de tarefas pendentes*) no Microsoft To Do são salvas como tarefas na caixa de correio do Exchange Online de um usuário. Isso significa que você pode usar a ferramenta Pesquisa de Conteúdo para pesquisar, acessar, excluir e exportar tarefas pendentes. Para saber mais, consulte [Configurar o Microsoft To Do](https://support.microsoft.com/office/set-up-microsoft-to-do-490c1a8c-2333-4952-8125-841afadb9620).
...
- Exporte os resultados da pesquisa e baixe uma cópia de todos os itens retornados pela pesquisa. Esse método é mais complexo, mas é uma boa maneira de baixar vários itens que respondem à DSR. Relatórios úteis também são incluídos com os resultados da pesquisa exportados. Você pode usar esses relatórios para obter informações adicionais sobre cada item. O relatório **Results.csv** é especialmente útil, pois ele contém muitas informações sobre os itens exportados, como o local exato do item (por exemplo, a caixa de correio das mensagens de e-mail, ou a URL de documentos ou listas localizadas em sites do SharePoint Online e OneDrive for Business). Essas informações ajudarão a identificar o proprietário do item, caso você precise contatá-lo durante o processo de investigação de DSR. Para obter mais informações sobre os relatórios que são incluídos na exportação dos resultados da pesquisa, consulte [Exportar um relatório de Pesquisa de Conteúdo](/microsoft-365/compliance/export-a-content-search-report).

#### <a name="preview-and-download-items"></a>Visualizar e baixar itens

Depois de executar uma nova pesquisa ou abrir uma pesquisa existente, é possível visualizar cada item que correspondeu à consulta de pesquisa a fim de verificar se está relacionado à DSR que você está investigando. Isso também inclui listas e páginas da Web do SharePoint que são retornadas nos resultados da pesquisa. Também é possível baixar o arquivo original se você tiver que fornecê-lo ao titular dos dados. Em ambos os casos, você faz uma captura de tela para atender à solicitação do titular dos dados para obter as informações.

Alguns tipos de item não podem ser visualizados. Se um tipo de item ou arquivo não tiver suporte para ser visualizado, existe a opção de baixar um item individual no seu computador local, ou uma unidade de rede mapeada, ou outro local de rede. Você pode visualizar apenas [tipos de arquivo com suporte](/microsoft-365/compliance/content-search).
...
Para obter mais informações sobre como visualizar resultados da pesquisa, confira [Visualizar resultados da pesquisa](/microsoft-365/compliance/content-search).
...
- Oferecer aplicativos do Office 365 que salvam dados em formato eletrônico nativo, legível por computador e comumente usado. Para obter mais informações sobre formatos de arquivo do Office, consulte [Formatos de Arquivo do Office - Documentos Técnicos](https://msdn.microsoft.com/library/office/cc313105(v=office.12).aspx).
...
Para ver instruções passo a passo detalhadas, confira [Exportar resultados da Pesquisa de Conteúdo do Centro de Conformidade e Segurança](/microsoft-365/compliance/export-search-results).
...
Para algumas solicitações de exportação de DSR, talvez você queira permitir que o titular dos dados baixe o conteúdo por conta própria. Isso permite que o titular dos dados acesse um site do SharePoint Online ou uma pasta compartilhada e selecione **Sincronizar** para sincronizar todo o conteúdo na biblioteca de documentos ou nas pastas selecionadas. Consulte:

- [Permitir que os usuários sincronizem arquivos do SharePoint com o novo cliente de sincronização do OneDrive](/sharepoint/let-users-use-new-onedrive-sync-client)
...
O "direito de apagar" pela remoção dos dados pessoais dos Dados do Cliente de uma organização é uma importante proteção do RGPD. A remoção de dados pessoais inclui excluir documentos ou arquivos inteiros, ou excluir dados específicos em um documento ou arquivo (que seria como as ações e os processos descritos na seção de retificação deste guia).
...
- **Exclusão temporária vs. exclusão irreversível:** nos serviços do Office 365, como o Exchange Online, SharePoint Online e OneDrive for Business, existe o conceito de *exclusão temporária* e *exclusão irreversível*, que se relaciona à capacidade de recuperação de um item excluído (geralmente por um período limitado) antes de ele ser permanentemente removido da nuvem da Microsoft sem chance de recuperação. Nesse contexto, um item excluído temporariamente pode ser recuperado por um usuário e/ou um administrador por um período limitado antes de ele ser excluído permanentemente. Quando um item for excluído de maneira irreversível, ele será marcado como remoção permanente e eliminado assim que for processado pelo serviço correspondente do Office 365. Veja a seguir como a exclusão temporária e a exclusão irreversível funcionam com itens em caixas de correio e sites (independentemente de quem os exclui: o proprietário dos dados ou um administrador):

  - **Caixas de correio:** um item é excluído temporariamente quando é excluído da pasta Itens Excluídos ou quando um usuário o exclui pressionando **Shift + Delete**. Quando o item é excluído temporariamente, ele é movido para a pasta Itens Recuperáveis na caixa de correio. Nesse ponto, o item pode ser recuperado pelo usuário até que o período de retenção do item excluído expire (no Office 365, a política de retenção de item excluído é de 14 dias, mas pode ser aumentado para até 30 dias por um administrador). Depois que o período de retenção expirar, o item é excluído de maneira irreversível e movido para uma pasta oculta (chamada *Limpezas*). O item será removido permanentemente (limpo) do Office 365 na próxima vez que a caixa de correio for processada (caixas de correio são processadas uma vez a cada 7 dias).

  - **Sites do SharePoint Online e OneDrive for Business**: quando um arquivo ou documento é excluído, ele é movido para a Lixeira do site (também chamada de *Lixeira de primeiro estágio* (que é como a Lixeira no Windows). O item permanecerá na Lixeira por 93 dias (o período de retenção do item excluído em sites no Office 365). Após esse período, o item é movido automaticamente para a Lixeira do conjunto de sites, também chamada de *Lixeira de segundo estágio*. (Observe que os usuários ou administradores – com as permissões apropriadas – também podem excluir itens da Lixeira de primeiro estágio.) Nesse ponto, o item fica excluído temporariamente; ele ainda pode ser recuperado pelo administrador de um conjunto de sites no SharePoint Online, ou pelo usuário ou administrador no OneDrive for Business). Quando um item é excluído da Lixeira de segundo estágio (manual ou automaticamente), ele se torna excluído irreversivelmente e não pode mais ser acessado por um usuário ou administrador. O período de retenção é de 93 dias nas lixeiras de primeiro e segundo estágio. Isso significa que a retenção da Lixeira de segundo estágio começa quando o item é excluído pela primeira vez. Portanto, o tempo total mínimo de retenção é de 93 dias em ambas as lixeiras.
...
- **Bloqueios legais e políticas de retenção:** no Office 365, uma "retenção" pode ser realizada em caixas de correio e em sites. Resumindo, isso significa que nada será removido permanentemente (excluído permanentemente) se uma caixa de correio ou site estiver em espera até que o período de retenção de um item expire ou até que a retenção seja removida. Isso é importante no contexto de excluir o Conteúdo do Cliente em resposta a uma DSR: se um item for excluído permanentemente de um local de conteúdo em espera, o item não será removido permanentemente do Office 365. Isso significa que ele pode ser recuperado por um administrador de TI. Se sua organização tiver um requisito ou uma política de que os dados sejam excluídos e irrecuperáveis no Office 365 em resposta à DSR, uma retenção precisará ser removida de uma caixa de correio ou site para excluir permanentemente os dados no Office 365. Mais do que provável, as diretrizes da sua organização para responder às DSRs possuem um processo em vigor para determinar se uma solicitação de exclusão de DSR específica ou uma retenção legal tem precedência. Se uma retenção for removida para excluir itens, ela poderá ser reimplementada depois que o item for excluído.
...
Depois de encontrar o documento em um site do SharePoint Online ou em uma conta do OneDrive for Business (seguindo as diretrizes na seção Descobrir deste guia) que precisa ser excluído, o responsável pela privacidade de dados ou administrador de TI precisaria receber as permissões necessárias para acessar o site e excluir o documento. Se adequado, o proprietário do documento também pode ser orientado a excluir o documento.
...
- Seção "Obter acesso aos documentos de OneDrive for Business do ex-funcionário" em [Obter acesso e fazer backup dos dados de um usuário antigo](/microsoft-365/admin/add-users/get-access-to-and-back-up-a-former-user-s-data)
...
- Use o cmdlet [Remover-SPOSite](/powershell/module/sharepoint-online/remove-sposite) para excluir o site e movê-lo para a Lixeira do SharePoint Online (exclusão temporária).
- Use o cmdlet [Remove-SPODeletedSite](/powershell/module/sharepoint-online/remove-spodeletedsite) para excluir permanentemente o site (exclusão irreversível).

Você não pode excluir um site que é colocado em uma retenção de Descoberta Eletrônica ou que foi atribuído a uma política de retenção. Os sites devem ser removidos de uma retenção de Descoberta Eletrônica ou política de retenção para que seja possível excluí-lo.

### <a name="deleting-a-onedrive-for-business-site"></a>Excluir um site do OneDrive for Business

Da mesma forma, você pode optar por excluir o site do OneDrive for Business de um usuário em resposta a uma solicitação de exclusão de DSR. Se você excluir a conta do Office 365 do usuário, o site do OneDrive for Business ficará retido (e restaurável) por 30 dias. Após 30 dias, ele será movido para a Lixeira do SharePoint Online (excluído por software) e, depois de 93 dias, excluído permanentemente (exclusão irreversível). Para acelerar esse processo, você pode usar o cmdlet [Remove-SPOSite](/powershell/module/sharepoint-online/remove-sposite) para mover o site do OneDrive for Business para a Lixeira e, em seguida, usar o cmdlet [Remove-SPODeletedSite](/powershell/module/sharepoint-online/remove-spodeletedsite) para excluí-lo permanentemente. Assim como nos sites do SharePoint Online, você não pode excluir o site do OneDrive for Business de um usuário se ele tiver sido atribuído a uma retenção de Descoberta Eletrônica ou a uma política de retenção antes da exclusão da conta do usuário.
...
Um administrador pode acelerar a exclusão do Perfil de Usuário de um usuário usando o cmdlet **Remove-SPOUserProfile** no PowerShell do SharePoint Online. Veja [Remove-SPOUserProfile](/powershell/module/sharepoint-online/remove-spouserprofile). Isso requer que o usuário seja pelo menos excluído por software no Azure Active Directory.
...
A maneira recomendada de excluir todas as configurações e informações da experiência do OneDrive for Business é remover o site do OneDrive for Business do usuário, após a reatribuição de quaisquer arquivos retidos para outros usuários. Um administrador pode excluir essas listas usando um [Script do PowerShell](/powershell/scripting/overview)  e [comandos de CSOM (Modelo de Objeto do Lado do Cliente do SharePoint)](/sharepoint/dev/sp-add-ins/complete-basic-operations-using-sharepoint-client-library-code). Confira [Excluir as configurações da experiência do OneDrive for Business para saber mais sobre as configurações](/sharepoint/delete-odfb-lists), como elas são armazenadas e como excluí-las.
...
Talvez você tenha que excluir itens nas caixas de correio do Exchange Online para atender a uma solicitação de exclusão de DSR. O administrador de TI pode excluir itens da caixa de correio de duas maneiras, dependendo de como deseja excluir os itens de destino: por exclusão temporária ou exclusão irreversível. Como os documentos nos sites do SharePoint Online ou OneDrive for Business, os itens em uma caixa de correio que está em retenção não podem ser excluídos permanentemente do Office 365. A retenção deve ser removida para que o item possa ser excluído. Mais uma vez, você terá que determinar se a retenção na caixa de correio ou a solicitação de exclusão de DSR tem precedência.

#### <a name="soft-delete-mailbox-items"></a>Exclusão temporária dos Itens de caixa de correio

Você pode usar a funcionalidade de Ação da Pesquisa de Conteúdo para excluir temporariamente itens que são devolvidos por uma Pesquisa de Conteúdo. Como explicado anteriormente, os itens excluídos temporariamente são movidos para a pasta Itens Recuperáveis na caixa de correio enquanto os itens com exclusão irreversível são permanentemente excluídos e não podem ser recuperados.

Aqui está uma rápida visão geral desse processo:
...
Para obter instruções detalhadas, confira [Pesquisar e excluir mensagens de email em sua organização](/microsoft-365/compliance/search-for-and-delete-messages-in-your-organization).
...
2. Exclua o usuário. Quando você inicialmente exclui o usuário, a conta do usuário é enviada para a Lixeira. Nesse ponto, o usuário é excluído temporariamente. Na exclusão temporária, a conta é retida por 30 dias, o que permite restaurá-la. Após 30 dias, a conta é excluída de modo irreversível automaticamente. Para obter instruções específicas, confira [Excluir usuários do Azure Active Directory](/azure/active-directory/add-users-azure-active-directory).<br><br> Você também pode excluir temporariamente uma conta no centro de administração. Confira [Excluir um usuário da sua organização](/microsoft-365/admin/add-users/delete-a-user). 

3. Se não desejar aguardar 30 dias para que a conta de usuário seja excluída irreversivelmente, você poderá fazer essa exclusão irreversível de modo manual. Para fazer isso no portal do Azure, vá até a lista de usuários excluídos recentemente e exclua o usuário permanentemente. Neste ponto, o usuário é excluído irreversivelmente. Para obter instruções, confira [Como excluir permanentemente um usuário excluído recentemente](/azure/active-directory/active-directory-users-restore).
...
O que precisa ser compreendido ao excluir um usuário é o que acontece com a caixa de correio do Exchange Online do usuário. Depois que a conta de usuário é excluída irreversivelmente (na etapa 3 do processo anterior), a caixa de correio do usuário excluído não é limpa automaticamente do Office 365. Leva até 60 dias depois que a conta de usuário é excluída irreversivelmente para removê-la permanentemente do Office 365. Veja a seguir o ciclo de vida da caixa de correio depois que a conta de usuário é excluída e uma descrição do estado dos dados da caixa de correio durante esse tempo:
...
As seções a seguir explicam como usar a funcionalidade no aplicativo do Microsoft Bookings para encontrar, acessar, exportar e excluir dados pessoais. Isso se aplica ao aplicativo Bookings autônomo e Bookings quando acessado por meio do Centro de empresas.
...
Todo o conteúdo do cliente é armazenado na caixa de correio do Exchange Online que hospeda o Bookings da organização. Esse conteúdo é mantido enquanto o proprietário da empresa e os clientes estiverem ativos no serviço, a menos que eles explicitamente solicitem que os dados sejam excluídos ou caso eles saiam do serviço. Esse conteúdo pode ser excluído por meio da interface do usuário no produto, com um cmdlet ou por meio da exclusão da caixa de correio de reserva relevante. Após o início da ação de exclusão, os dados são excluídos no período de tempo definido pelo proprietário da empresa. 
...
- **Contatos do cliente:** Contatos podem ser criados manualmente nos clientes do Bookings para a Web, para iOS e Android ou podem ser importados de um dispositivo móvel. Contatos também são criados automaticamente durante o uso da página de reserva de autoatendimento. Eles contêm EUII e são armazenados na caixa de correio do Bookings.
- **Detalhes dos funcionários:** O conteúdo do cliente inclui dados sobre os funcionários que estão qualificados para prestar serviços criados por meio dos clientes do Bookings para a Web, para iOS ou Android. Os detalhes da equipe podem conter nome, endereço de email e número de telefone.
- **Marcação de eventos :** Trata-se de reuniões do cliente e o conteúdo do cliente relacionado criado pela empresa usando um cliente da Web ou um aplicativo para iOS/Android ou criado pelo cliente usando uma página de reserva pública (ou uma página do Facebook). Os eventos podem incluir nome, endereço, endereço de email, número de telefone e detalhes de compromisso.
- **Solicitações de reunião, confirmações/cancelamentos/atualizações e lembretes por email:** Trata-se de mensagens de emails enviadas pelo sistema em associação com as reservas. Contêm dados de funcionários e clientes que foram inseridos no momento da reserva.
...
- **Detalhes dos funcionários:** Você pode excluir a equipe no painel do Bookings. Para excluir funcionários permanentemente, você pode excluir a respectiva conta do Office 365.
...
- Clientes/contatos são criados pela empresa usando o cliente da Web ou o aplicativo móvel (iOS e Android) ou usando o aplicativo quando uma campanha de marketing por email é enviada a um contato de negócios. Os dados de clientes podem incluir nome, endereço, endereço de email e números de ID fiscal. Os contatos são compartilhados em todos os aplicativos do Centro de empresas.
...
Um administrador pode usar a ferramenta Pesquisa de Conteúdo no Centro de Conformidade e Segurança para procurar arquivos de alunos (nas bibliotecas de Trabalho do Aluno e Arquivos da Classe) relacionados a envios em tarefas e arquivos relacionados a tarefas. Por exemplo, um administrador pode pesquisar todos os sites do SharePoint na organização e usar o nome do aluno e o nome da classe ou tarefa na consulta de pesquisa para localizar dados relevantes para uma solicitação de DSR.

Da mesma forma, um administrador pode pesquisar arquivos do professor relacionados a tarefas para arquivos que um professor distribuiu aos alunos. Por exemplo, um administrador pode pesquisar todos os sites do SharePoint na organização e usar o nome do professor e o nome da classe ou atribuição na consulta de pesquisa para localizar dados relevantes para uma solicitação de DSR.

Para saber mais, confira:

- [Documentação do Administrador de Tarefas ](/microsoft-365/education/deploy/assignments-admin-documentation)
...
Os seguintes tipos de dados do Assignments não são armazenados no site do SharePoint de equipe de classe e, portanto, não podem ser descobertos usando a Pesquisa de Conteúdo. Esses dados incluem o seguinte:
...
Mesmo que um aluno não faça mais parte de uma classe, os dados podem ainda estar presentes na classe e ser marcados como "não registrado". Nesse caso, um aluno que envia uma solicitação de DSR precisa fornecer ao administrador a lista de classes em que foi formalmente registrado.
...
- [Configurar Tarefas para o Teams](/microsoft-365/education/deploy/configure-assignments-for-teams)
- [Obter uma lista de classes para um aluno específico](/microsoft-365/education/deploy/assignments-script-get)
- [Exportar dados de alunos e professores de tarefas](/microsoft-365/education/deploy/assignments-script-export).
...
- [Configurar Tarefas para o Teams](/microsoft-365/education/deploy/configure-assignments-for-teams)
- [Obter uma lista de classes para um aluno específico](/microsoft-365/education/deploy/assignments-script-get)
- [Excluir dados de alunos de Tarefas](/microsoft-365/education/deploy/assignments-script-delete).
...
- [Administrador global do Azure Active Directory](/azure/active-directory/active-directory-assign-admin-roles-azure-portal)
...
Depois de tornar a si mesmo um proprietário, vá para **Fluxo** \> **Meus fluxos** \> **Fluxos da equipe** para acessar o fluxo. A partir daí, você pode baixar o histórico de execuções ou exportar o fluxo. Confira:
...
Um administrador pode adicionar a si mesmo como um proprietário dos fluxos de um usuário no centro de administração do Flow. Se um usuário deixar a sua organização e sua conta do Office 365 for excluída, os fluxos dos quais ele é o único proprietário serão retidos. Isso ajuda a organização a fazer a transição dos fluxos para novos proprietários e a evitar qualquer interrupção nos negócios de fluxos que podem ser usados em processos corporativos compartilhados. Um administrador precisa então determinar se deve excluir os fluxos que eram de propriedade do usuário ou reatribuir a novos proprietários, e tomar essa ação.
...
Os usuários do Kaizala podem usar seu dispositivo móvel para ver o conteúdo do Kaizala que você criou em seu dispositivo. Para determinar se os aplicativos móveis do Kaizala são um local onde dados pessoais responsivos a uma DSR provavelmente residirão, você pode pedir ao titular de dados que pesquise as informações solicitadas no aplicativo do Kaizala.
...
- [Exportar ou excluir seus dados no aplicativo móvel Kaizala](/office365/kaizala/export-or-delete-your-data)
...
Os planos do Planner são associados a um Grupo do Microsoft 365 e os arquivos desse grupo são armazenados em um site do SharePoint Online associado do grupo. Isso significa que você pode usar a Pesquisa de Conteúdo para encontrar arquivos do Planner pesquisando o site do Grupo do Microsoft 365. Para isso, você precisa ter a URL do Grupo do Microsoft 365. Confira [Pesquisar Grupos do Microsoft 365 e Microsoft Teams](/microsoft-365/compliance/content-search) no tópico de ajuda “Pesquisa de Conteúdo no Microsoft 365” para ver dicas de como obter informações sobre os Grupos do Office 365 que ajudem a pesquisar arquivos do Planner no site do SharePoint Online correspondente.

#### <a name="access"></a>Acessar

Conforme explicado anteriormente, você pode pesquisar o site e a caixa de correio subjacentes do SharePoint Online que estão associados a um plano. Em seguida, você pode visualizar ou baixar os resultados da pesquisa relacionados para acessar os dados.
...
Para excluir painéis, relatórios e pastas de trabalho, confira [Excluir quase tudo no serviço do Power BI](/power-bi/service-delete).
...
- [Administrador global](/microsoft-365/admin/add-users/assign-admin-roles) ou
- [Administrador global do Azure Active Directory](/azure/active-directory/active-directory-assign-admin-roles-azure-portal)
...
Depois de ter acesso ao aplicativo do usuário, é possível usar um navegador da Web para abrir o aplicativo. Depois de abrir um aplicativo, você pode fazer uma captura de tela dos dados. Confira [Usar o PowerApps em um navegador da Web](/powerapps/run-app-browser).

#### <a name="delete"></a>Excluir

Como o PowerApps permite aos usuários criar aplicativo de linha de negócios, que pode ser uma parte essencial das operações diárias da sua organização, quando um usuário sai da organização e sua conta do Office 365 é excluída, o administrador precisa determinar se deve excluir os aplicativos que pertenciam ao usuário ou reatribuir a novos proprietários. Isso ajuda a organização a fazer a transição de aplicativos para novos proprietários e evita interrupções nos negócios de aplicativos que podem ser usados em processos corporativos compartilhados.
...
Para descobrir conteúdo gerado ou carregado para o Stream que pode ser relevante para uma solicitação do titular de dados, um administrador do Stream pode executar um relatório de usuário para determinar quais vídeos, descrições de vídeo, grupos, canais ou comentários um usuário do Stream pode ter carregado, criado ou postado. Para obter instruções sobre como gerar um relatório, confira [Gerenciamento de dados do usuário no Microsoft Stream](/stream/managing-user-data). A saída do relatório está no formato HTML e contém hiperlinks que podem ser usados para navegar até os vídeos de interesse potencial. Se quiser exibir um vídeo que tem permissão personalizada definida e não fizer parte dos usuários originais para os quais o vídeo foi destinado, você poderá exibir no modo de administrador. Confira [Recursos de administração no Microsoft Stream](/stream/manage-content-permissions).  
...
Para excluir ou editar vídeos ou outro conteúdo do Stream, um administrador do Stream pode selecionar o modo de exibição no modo de administrador para realizar a função necessária. Veja [Recursos de administração do Microsoft Stream](/stream/manage-content-permissions). Se um usuário sair da organização e desejar que seu nome seja removido para não ser exibido ao lado de vídeos que ele carregou, você poderá remover o nome ou substituí-lo por outro. Veja [Como gerenciar usuários excluídos do Microsoft Stream](/stream/managing-deleted-users).
...
1. Dê a si mesmo acesso à conta do OneDrive for Business do usuário. Veja a seção "Obter acesso aos documentos do OneDrive for Business do ex-funcionário" em [Obter acesso e fazer backup dos dados de um ex-usuário](/microsoft-365/admin/add-users/get-access-to-and-back-up-a-former-user-s-data).
...
1. Dê a si mesmo acesso à conta do OneDrive for Business do titular de dados. Veja a seção "Obter acesso aos documentos de OneDrive for Business do ex-funcionário" em [Obter acesso e fazer backup dos dados de um ex-usuário](/microsoft-365/admin/add-users/get-access-to-and-back-up-a-former-user-s-data)
...
No centro de administração do Yammer, um administrador verificado pelo Yammer (administrador global ou administrador verificado configurado no Yammer) pode exportar dados pertencentes a um determinado usuário. A exportação inclui as mensagens e os arquivos postados e modificados pelo usuário e as informações sobre tópicos e grupos criados pelo usuário. Quando uma exportação de dados específica de usuário é executada, o administrador também recebe uma mensagem na caixa de entrada com os dados de atividade da conta do usuário se for de sua escolha. Para obter instruções detalhadas, confira [Yammer Enterprise: privacidade](/yammer/manage-security-and-compliance/gdpr-requests-in-yammer-enterprise).
...
Para obter instruções de como exportar dados, confira [Gerenciar solicitações de assuntos dados GDPR no Yammer Enterprise](/yammer/manage-security-and-compliance/gdpr-requests-in-yammer-enterprise). Você deve executar uma exportação por usuário para cada rede do Yammer da qual o usuário é um membro.

O Yammer tem configurações de retenção de dados que exclui os dados de modo temporário ou irreversível quando um usuário exclui uma mensagem ou um arquivo. Se essa opção for definida para exclusão temporária, os dados que um usuário excluiu serão incluídos na exportação. Se a configuração de retenção de dados do Yammer for definida para exclusão irreversível, as informações excluídas não serão mais armazenadas no Yammer, de modo que não serão incluídas na exportação.

#### <a name="delete"></a>Excluir

O Yammer permite que administradores verificados executem uma exclusão em conformidade com o RGPD usando o centro de administração do Yammer caso recebam uma DSR. Essa opção é chamada de Apagar Usuário e suspende o usuário por 14 dias e depois remove todos os seus dados pessoais, com exceção de arquivos e mensagens. Se o usuário for um usuário convidado, isso deve ser feito para cada rede externa da qual o convidado é membro.
...
Para obter etapas detalhadas para remover um usuário, confira [Gerenciar solicitações de assunto de dados GDPR no Yammer Enterprise](/yammer/manage-security-and-compliance/gdpr-requests-in-yammer-enterprise).

## <a name="responding-to-dsr-rectification-requests"></a>Responder às solicitações de retificação de DSR

Se um titular dos dados tiver solicitado a retificação dos dados pessoais que residem nos dados de sua organização armazenados no Office 365, você e sua organização têm que determinar se é apropriado atender à solicitação. Se você optar por atendê-la, a retificação dos dados poderá incluir a execução de ações como editar, redigir ou remover dados pessoais de um documento ou outro tipo de item. A maneira mais conveniente de fazer isso é solicitar que o proprietário dos dados/documento use o aplicativo apropriado do Office 365 para fazer a alteração solicitada. Uma alternativa é pedir a um administrador de TI da organização que faça a alteração. Isso provavelmente exigirá que o administrador de TI (ou outras pessoas em sua organização com os privilégios adequados, como o administrador do conjunto de sites do SharePoint Online) atribua a si mesmo ou a alguém que esteja trabalhando na DSR, as permissões necessárias para obter acesso ao documento ou ao local do conteúdo em que o documento está localizado para fazer a alteração diretamente no documento.
...
- [Gerenciar administradores para um conjunto de sites](/sharepoint/manage-site-collection-administrators)
...
- [Conceder permissões de caixa de correio para outros usuários no Office 365](/microsoft-365/admin/add-users/give-mailbox-permissions-to-another-user)
...
- Retifique as propriedades no próprio Active Directory local do usuário. Para clientes que estão sincronizando propriedades do usuário, como Nome de Exibição, Nome, etc., de um AD local, essas propriedades devem ser retificadas nele. As propriedades devidamente mapeadas fluem para o Office 365, e depois para o OneDrive for Business e SharePoint Online.
...
Isto não afetará todas as experiências, o que pode reter as informações antigas. Por exemplo, o nome do usuário como texto no documento.
...
Depois que essas alterações são feitas, você poderá aproveitar os recursos da [atualização de dados agendada](/power-bi/refresh-scheduled-refresh) para atualizar o conjunto de dados que está armazenado no Power BI, de modo que os dados revisados sejam refletidos nos ativos do Power BI dependentes. Para ajudar a atender aos requisitos do RGPD, é preciso ter políticas definidas, a fim de garantir que você esteja atualizando os dados em uma cadência adequada.

### <a name="making-changes-to-content-in-yammer"></a>Fazer alterações no conteúdo no Yammer

Para mensagens, um usuário pode editar uma determinada mensagem de modo a retificar qualquer imprecisão. Ele pode solicitar uma lista de todas as respectivas mensagens a um administrador verificado do Yammer, e então selecionar um link do arquivo para analisar cada mensagem.
...
A remoção da licença do SharePoint Online de um usuário não o impedirá de acessar a respectiva conta do OneDrive for Business se ela existir.  É preciso remover as permissões do usuário para a respectiva conta do OneDrive for Business.  Você pode fazer isso removendo o usuário como um proprietário do conjunto de sites de sua conta do OneDrive for Business. Especificamente, é preciso remover o usuário dos grupos Administradores de Conjunto de Sites em seu perfil de usuário. Confira a seção “Adicionar e remover administradores em uma conta do OneDrive for Business” em [Gerenciar perfis de usuário no Centro de Administração do SharePoint](/sharepoint/manage-user-profiles). 

### <a name="turning-off-an-office-365-service"></a>Desativar um serviço do Office 365

Outra maneira de atender a uma solicitação DSR para restringir o processamento de dados é desativar um serviço do Office 365. Isto afeta todos os usuários em toda a organização e os impede de usar o serviço ou acessar dados no serviço.

A maneira mais conveniente de desativar um serviço é usar o PowerShell do Office 365 e remover a licença de usuário correspondente de todos os usuários na organização. Isso, de fato, impedirá a todos de acessar dados no serviço em questão. Para obter instruções detalhadas, confira [Desativar o acesso aos serviços com o PowerShell do Office 365](/microsoft-365/enterprise/disable-access-to-services-with-microsoft-365-powershell) e siga os procedimentos para desativar os serviços do Office 365 para usuários de um único plano de licenciamento.
...
Um administrador do SharePoint pode impedir temporariamente todos os usuários de acessar um conjunto de sites do SharePoint Online bloqueando o conjunto de sites (usando o comando usando o comando **Set-SPOSite - LockState** no PowerShell do SharePoint Online). Isso impedirá os usuários de acessar o conjunto de sites e quaisquer conteúdos ou dados que estejam localizados no site. Se, posteriormente, você determinar que os usuários devem poder acessar o site, o administrador poderá desbloquear o site. Confira [Set-SPOSite](/powershell/module/sharepoint-online/set-sposite) para obter informações sobre como executar esse cmdlet do PowerShell.

### <a name="preventing-a-user-from-signing-in-to-office-365"></a>Impedir um usuário de entrar no Office 365

Um administrador de TI também pode impedir um usuário de entrar no Office 365, o que pode impedi-lo de acessar qualquer serviço online do Office 365 ou processar quaisquer dados armazenados no Office 365. Confira [Bloquear o acesso de um funcionário antigo aos dados do Office 365](/microsoft-365/admin/add-users/remove-former-employee).
...
- **Dados da lista de pessoas:** Essas são as pessoas que o usuário exibiu no Delve. A lista **Pessoas** é mostrada no painel esquerdo na home page. Os usuários podem exportar a lista de pessoas que exibiram mais recentemente no Delve.
- **Dados favoritos:** Esses são os quadros e documentos que o usuário marcou como seus favoritos. A página **Favoritos** mostra quadros e documentos que o usuário adicionou aos seus favoritos. Os usuários podem exportar uma lista de seus quadros e documentos atuais favoritos.
- **Dados de configurações de recurso:** Trata-se de configurações do Delve ou ações decorrentes do uso do Delve por um usuário. Os usuários podem exportar uma lista completa dessas configurações.
...
Para restringir o processamento no Delve em sua organização, você pode desativar o Office Graph. Saiba mais [aqui](/sharepoint/delve-for-office-365-admins).
...
O MyAnalytics fornece estatísticas aos usuários para ajudá-los a entenderem como passam o tempo no trabalho. Para ajudar os usuários a melhor entenderem os dados apresentados a eles no painel pessoal e como esses dados são calculados, direcione seus usuários ao [Painel pessoal do MyAnalytics](/workplace-analytics/myanalytics/use/dashboard-2).
...
Para restringir o processamento para um usuário específico, você pode optar por retirá-lo do MyAnalytics. Para saber como, confira o artigo sobre [definição das configurações de usuário do MyAnalytics](/workplace-analytics/myanalytics/setup/configure-myanalytics).
...
O Workplace Analytics permite que as organizações aumentem os dados do Office 365 com seus próprios dados corporativos para obter insights sobre a produtividade organizacional, os padrões de colaboração e o engajamento do funcionário. [Este artigo](/workplace-analytics/index-orig) explica o controle que a sua organização tem sobre os dados que o Workplace Analytics processa e quem tem acesso a esses dados.

Para ajudar com as DSRs no Workplace Analytics: 

1. Determine se sua organização está usando o Workplace Analytics. Para saber mais, confira [Atribuir licenças a usuários](/microsoft-365/admin/manage/assign-licenses-to-users). Se sua organização não estiver usando o Workplace Analytics, não haverá ação adicional.

2. Se a organização estiver usando o Workplace Analytics, veja quem em sua organização foi atribuído à função de administrador do Workplace Analytics. Você também deve determinar se a caixa de correio do titular dos dados está licenciada para o Workplace Analytics. Se necessário, peça ao administrador do Workplace Analytics que contate o Suporte da Microsoft para lidar com as solicitações DSRs a seguir: 

#### <a name="access-and-export"></a>Acessar e exportar

Os relatórios de análise do Workplace Analytics criados por você podem ou não conter dados pessoais dos usuários que a sua organização licenciou para o Workplace Analytics, dependendo das informações que a organização usou para suplementar os dados do Office 365. O administrador do Workplace Analytics precisa analisar esses relatórios a fim de determinar se eles contêm dados pessoais de um usuário. Se um relatório não contiver dados pessoais de um usuário, você precisa decidir se deseja fornecer uma cópia desse relatório ao usuário. O Workplace Analytics permite exportar o relatório. 

#### <a name="rectify"></a>Retificar

Conforme explicado acima, o Workplace Analytics usa os dados do Office 365 com os dados organizacionais que você fornece para gerar relatórios de seu interesse. Os dados do Office 365 não podem ser retificados – eles se baseiam nas atividades de calendário e email de um usuário. No entanto, os dados organizacionais que você carregou no Workplace Analytics para gerar o relatório podem ser retificados. Para fazer isso, é necessário corrigir os dados de origem, carregá-los e executar novamente o relatório para gerar um novo relatório do Workplace Analytics.
...
2. Exclua a entrada do Azure Active Directory (AAD) para o assunto dos dados. (Para saber mais, confira [excluir um usuário](/azure/active-directory/fundamentals/add-users-azure-active-directory#delete-a-user).)
...
4. Exporte uma cópia dos dados de RH do sistema de RH da empresa (consulte [exportar dados](/workplace-analytics/setup/prepare-organizational-data)), remova informações do assunto dos dados desse arquivo de dados de RH e carregue o arquivo de dados de RH editado no formato. csv para o Workplace Analytics (consulte [Carregar dados organizacionais](/workplace-analytics/setup/upload-organizational-data)).
...
O administrador de locatários é a única pessoa em sua organização que tem acesso aos logs gerados pelo sistema associados ao uso de serviços e aplicativos do Office 365 por um usuário específico. Dados recuperados para uma solicitação de exportação são fornecidos em um formato legível por máquina em arquivos que permitem ao usuário saber com quais serviços os dados estão associados. Como mencionado acima, dados recuperados não incluem dados que possam comprometer a segurança ou estabilidade do serviço.
...
4. Preencha a **Solicitação de exportação de dados**:
    ...
    - **Conta de armazenamento**. Selecione o local do Armazenamento do Microsoft Azure (Blob). Para saber mais, consulte o artigo Introdução ao Armazenamento do Microsoft Azure — Armazenamento de Blob.
...
A solicitação de exportação se insere no status **Pendente**. Você pode visualizar o status do relatório na folha **Privacidade do usuário** > **visão geral**.
...
Se você tiver problemas ao exportar ou excluir dados do Portal do Azure, acesse a folha **Ajuda e Suporte** do portal do Azure e envie um novo tíquete na folha **Gerenciamento de Assinaturas** > **Solicitação de Segurança e Conformidade para Assinaturas** > **Folha de Privacidade e Solicitações de GDPR**.

> [!NOTE]
> Quando você exporta dados do portal do Azure, os dados gerados pelo sistema para alguns aplicativos não serão exportados. Para exportar dados para esses aplicativos, consulte [Etapas adicionais para exportar dados de log gerados pelo sistema](/microsoft-365/compliance/gdpr-system-generated-log-data).

O exemplo a seguir resume o acesso e a exportação de logs gerados pelo sistema:

- **Quanto tempo uma solicitação de exportação que usa o portal do Azure leva para concluir uma solicitação?**: Isso depende de vários fatores. Normalmente, ele deve ser concluído em um ou dois dias, mas pode levar até 30 dias.
...
Uma exceção a esse período de 30 dias é que a exclusão permanente da conta de usuário no Exchange Online demora mais de 30 dias. Isso ocorre por causa natureza crítica do conteúdo do Exchange Online e da prevenção da perda acidental de dados. O Exchange Online foi projetado para colocar intencionalmente os dados em um estado de retenção por até 60 dias depois de excluir permanente uma conta de usuário. Para excluir permanentemente os dados do Exchange Online de um usuário em um período de 30 dias, exclua permanentemente a conta de usuário no Azure Active Directory e entre em contato com o [Suporte da Microsoft](https://support.microsoft.com/) e solicite que os dados do Exchange Online do usuário sejam removidos manualmente fora do processo de exclusão agendado. Para obter mais informações, consulte [Remover dados do Exchange Online](#removing-exchange-online-data), que foi explicado anteriormente neste guia
...
- Yammer – [ gerenciar solicitações de entidades de dados GDPR do Yammer Enterprise](/yammer/manage-security-and-compliance/gdpr-requests-in-yammer-enterprise)
- Kaizala - [Exportar ou excluir dados organizacionais do usuário no Kaizala](/office365/kaizala/export-or-delete-a-user-s-data)
...
"Dados de Suporte" são os dados que você e os seus usuários fornecem à Microsoft em caso de engajamento com a Microsoft para receber suporte a produtos relacionados ao Office 365 ou outros produtos e serviços da Microsoft (por exemplo, para solução de comportamento inesperado de produtos). Alguns desses dados podem conter dados pessoais. Para saber mais, confira [Dados de serviços profissionais e Suporte da Microsoft que o titular solicita para o RGPD](/microsoft-365/compliance/gdpr-dsr-prof-services).
...
As Partes 1-3 deste guia abrangem produtos e serviços para os quais a Microsoft é um processador de dados da sua organização e, portanto, o recurso DSR é disponibilizado para o administrador de locatários. Há várias circunstâncias em que os usuários da organização podem usar a respectiva conta corporativa ou de estudante (também conhecida como "ID do Azure Active Directory" ou "AAD") para entrar em produtos e serviços da Microsoft para os quais a Microsoft é um controlador de dados. Para todos esses produtos e serviços, os usuários precisam iniciar suas próprias solicitações de titular de dados diretamente à Microsoft e a Microsoft tratará as solicitações diretamente com o usuário. Por padrão, os produtos e serviços que envolvem armazenamento de conteúdo criado pelo usuário permitem que os usuários acessem, exportem, retifique e excluam o respectivo conteúdo como parte da funcionalidade inerente dos produtos. Os cenários em que isso pode se aplicar incluem os seguintes:

- **Serviços on-line opcionais conectados:** o Microsoft 365 Apps para empresas disponibiliza certos serviços on-line opcionais conectados ao usuário. A lista de serviços e controles de usuário relacionados são listados [aqui](https://support.office.com/article/microsoft-s-other-connected-services-92c234f1-dc91-4dc1-925d-6c90fc3816d8). Você pode decidir se quer permitir que os usuários finais usem esses serviços. Para obter mais informações, consulte [Como os administradores podem gerenciar os serviços de controlador no Microsoft 365 Apps para empresas](/DeployOffice/manage-controller-services-office-365-proplus). Se esses serviços opcionais processam dados pessoais, a Microsoft é um controlador de dados desses serviços.
- **Comentários dos usuários:** se os usuários optarem por enviar comentários dos produtos e serviços da Microsoft, a Microsoft é um controlador de dados desses comentários na medida em que contiver dados pessoais. A Microsoft atenderá às solicitações dos titulares de dados quanto aos comentários coletados pela Microsoft (incluindo comentários gerenciados por subprocessadores da Microsoft), exceto nos casos em que a Microsoft tiver instruído os usuários a não incluírem dados pessoais durante o processo de coleta de comentários. Exceções: se a Microsoft tiver instruído os usuários a não incluírem dados pessoais durante o processo de coleta de comentários, a Microsoft contará com essa instrução e presumirá que nenhum dado pessoal foi fornecido. Os usuários que criaram uma conta separada com provedores de serviços de comentários de terceiros devem atender à DSR diretamente a esses provedores.
...
- **Produtos ou serviços adquiridos pelo usuário:** se você permitir que seus usuários, atuando em sua capacidade individual, adquiram produtos ou serviços da Microsoft que usam o AAD para autenticação (por exemplo, complementos do Office ou aplicativos disponíveis em um Microsoft Store), a Microsoft pode ser um controlador de dados. Para tais produtos ou serviços da Microsoft, os usuários precisam entrar em contato diretamente com a Microsoft para iniciar uma DSR.
...
- Use a pesquisa interna para pesquisar todo o conteúdo relacionado a um titular de dados específico. Quando você cria uma ocorrência e inicia a pesquisa, estes locais de conteúdo são pesquisados:
...
- Controle quem tem acesso à ocorrência adicionando pessoas como membros da ocorrência; somente membros podem acessar a ocorrência e só podem ver suas ocorrências na lista de ocorrências na página de ocorrências de DSR no Centro de Conformidade e Segurança. Além disso, você pode atribuir diferentes permissões a diferentes membros da mesma ocorrência. Por exemplo, você pode permitir que alguns membros exibam somente a ocorrência e os resultados de uma Pesquisa de Conteúdo e permitir que outros membros criem pesquisas e exportem resultados da pesquisa.

- Crie trabalhos de exportação para exportar os resultados da pesquisa em resposta a uma solicitação de exportação de DSR. É possível exportar todo o conteúdo retornado pela Pesquisa de Conteúdo. Outros dados do Office 365 relacionados a um titular de dados também são exportados.

- Crie trabalhos de exportação para exportar os resultados da pesquisa em resposta a uma solicitação de exportação de DSR. É possível exportar todo o conteúdo retornado pela Pesquisa de Conteúdo. Você pode exportar os logs gerados pelo sistema para o serviço de Roaming do Office.

- Excluir ocorrências quando o processo de investigação de DSR é concluído. Isto remove todas as pesquisas de conteúdo e os trabalhos de exportação associados à ocorrência.

Para começar a usar os casos de DSR, confira [Gerenciar solicitações de titular de dados do RGPD com a ferramenta de casos de DSR no Centro de Conformidade e Segurança](/microsoft-365/compliance/manage-gdpr-data-subject-requests-with-the-dsr-case-tool).

> [!IMPORTANT]
> Um Administrador de Descoberta Eletrônica pode exibir e gerenciar todas as ocorrências de DSR em sua organização. Para obter informações sobre as diferentes funções relacionadas à Descoberta eletrônica, confira [Atribuir permissões da Descoberta Eletrônica a membros de ocorrência potenciais](/Office365/SecurityCompliance/assign-ediscovery-permissions).
...
Você pode pesquisar no log de auditoria por atividades específicas, tipos de atividades, atividades executadas por um usuário específico e outros critérios de pesquisa. Além do SharePoint Online e do OneDrive for Business, você também pode pesquisar atividades no Flow, no Power BI e no Microsoft Teams. Os registros de auditoria são retidos por 90 dias. Assim, você não poderá pesquisar por atividades de usuário que ocorreram há mais de 90 dias. Para obter uma lista completa das atividades auditadas e como pesquisar o log de auditoria, consulte [Pesquisar o log de auditoria no Centro de Conformidade e Segurança](/microsoft-365/compliance/search-the-audit-log-in-security-and-compliance).
