...
- _*Falso positivo**: um evento que atende aos critérios de detecção, mas é considerado parte de uma prática comercial normal e pode precisar ser filtrado. A equipe de serviço identificará a causa raiz dos falsos positivos e os tratará de forma sistemática usando fontes de detecção e ajustando-as conforme necessário.
