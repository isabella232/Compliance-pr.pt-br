...
Os serviços no escopo da Microsoft são mostrados no relatório [de atestado SOC 2 tipo 2](offering-soc-2.md) do Azure.
...
Para obter mais informações sobre o Azure, o Dynamics 365 e outros serviços de conformidade do serviços online, consulte [oferta do SOC 3 do Azure](/azure/compliance/offerings/offering-soc-3).
