...
**Kaizala**: O portal de gerenciamento Kaizala permite que você exporte dados de uso de produtos e serviços da organização e depois use funcionalidades do Excel para filtrar os dados de um usuário específico. Para obter instruções detalhadas, confira [Exportar ou excluir dados organizacionais de um usuário no Kaizala](/office365/kaizala/export-or-delete-a-user-s-data).
