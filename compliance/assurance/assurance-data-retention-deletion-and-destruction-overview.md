...
A Microsoft tem uma política Padrão de Tratamento de Dados para o Microsoft 365 que especifica por quanto tempo os dados do cliente são mantidos após a exclusão. Geralmente, há dois cenários nos quais os dados do cliente são excluídos:
