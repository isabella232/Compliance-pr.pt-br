...
| [Pesquisa e retenção de conteúdo de caixa de correio](https://docs.microsoft.com/exchange/security-and-compliance/in-place-ediscovery/in-place-ediscovery) | Fornece detalhes de todas as alterações para In-Place descoberta eletrônica ou configurações de bloqueio de In-Place em caixas de correio. |
